...
const TIMELINE = [
  ...
  },
  {
    ...
    body: '학생 비자로 전환해 퍼스 대학에 입학했어요. 공부하면서 자연스럽게 현지인 친구들과 더 깊이 어울리게 됐고, "로컬이 진짜 좋아하는 것"과 "관광지로 알려진 것"이 얼마나 다른지 매일 실감했습니다. 스완 강변 피크닉 스팟, 프리맨틀 마켓의 진짜 맛집, 주말마다 열리는 코테슬로 비치 선셋—이 기록들이 나중에 투어 루트의 씨앗이 됐어요.',
    img: 'https://images.unsplash.com/photo-1605186186469-89ee53d05d6d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=90&w=800',
